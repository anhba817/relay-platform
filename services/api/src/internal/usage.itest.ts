...
// THE GATEWAY'S CREDENTIAL, and this chapter is why the variable changed.
//
...
/** The dispatcher's own credential, kept so the refusal this chapter adds can be
 * tested in BOTH directions: the gateway's credential refused on a dispatch route,
 * and the dispatcher's refused here. One direction proves a filter exists; two prove
 * it discriminates. */
