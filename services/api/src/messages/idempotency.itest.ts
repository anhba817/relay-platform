...
describe("idempotency enforcement (FR-MSG-04, DR-03)", () => {
  ...
  it("a retry returns the original's attachments and writes no second row (T050, FR-011)", async () => {
  ...
  it("recovers a TOMBSTONE with an empty list and nothing published (T050a, FR-011, FR-012)", async () => {
